...
const ChartAccessForWeek = React.forwardRef<
  React.ElementRef<typeof Card>,
  React.ComponentProps<typeof Card>
>(({ className, ...props }, ref) => {
  const t = useTranslations("Dashboard.chart.access.card");
  ...
  const [activeChart, setActiveChart] =
    React.useState<keyof ChartConfig>("unlocks");
...
ChartAccessForWeek.displayName = "ChartAccessForWeek";

export { ChartAccessForWeek };
