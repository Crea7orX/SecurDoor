...
const ChartDashboardActiveUsersForWeek = React.forwardRef<
  React.ElementRef<typeof Card>,
  React.ComponentProps<typeof Card>
>(({ className, ...props }, ref) => {
  const t = useTranslations("Dashboard.chart.active_users.dashboard");
...
ChartDashboardActiveUsersForWeek.displayName =
  "ChartDashboardActiveUsersForWeek";

export { ChartDashboardActiveUsersForWeek };
