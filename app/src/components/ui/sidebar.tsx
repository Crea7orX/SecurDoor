...
const SidebarSheet = React.forwardRef<
  ...
  React.ComponentProps<typeof SheetContent> & {
    triggerClassName?: React.ComponentProps<typeof SheetTrigger>["className"];
  }
>(({ side = "left", className, triggerClassName, children, ...props }, ref) => {
  return (
    <Sheet>
      ...
      <SheetContent
        className={cn(
          "w-64 bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden",
          className,
        )}
        side={side}
        ref={ref}
