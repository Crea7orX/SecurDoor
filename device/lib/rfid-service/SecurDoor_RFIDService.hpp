...
#ifndef SECURDOOR_RIFDSERVICE_HPP
#define SECURDOOR_RIFDSERVICE_HPP

#include <Arduino.h>
#include <MFRC522.h>  // You may need to adjust the include path
...
#endif // SECURDOOR_RIFDSERVICE_HPP
